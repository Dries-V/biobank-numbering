...
const FIRST_INDEX = 62313
const INPUT_FILE = '/Users/driesv/Git/biobank-numbering/example/Biobank aanvulling 2021_voor Dries.xlsx'
const OUTPUT_FILE = '/Users/driesv/Git/biobank-numbering/example/filtered.xlsx'
...
const addNumbers = (sheet) => {
  const generator = getCode(FIRST_INDEX)
...
const main = async () => {
  const xls = new Excel(INPUT_FILE)
  ...
  const indexSampleCode = fromSheet.getColumnIndex('Sample_Code') || fromSheet.getColumnIndex('Sample-Code')
